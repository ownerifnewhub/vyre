-- ============================================================
-- VORTEX ANTI BAT (SLIDING TOGGLE + FULL IMMUNITY)
-- ============================================================
...
ToggleRow.Position = UDim2.new(0,10,0,144)
ToggleRow.Size = UDim2.new(1,-20,0,38)
ToggleRow.BackgroundColor3 = VORTEX_DARKER
...
ToggleLabel.TextColor3 = VORTEX_WHITE
...
ToggleButton.Position = UDim2.new(1,-63,0.5,-11)
ToggleButton.BackgroundColor3 = VORTEX_DARKER
ToggleButton.BorderSizePixel = 0
ToggleButton.Text = "LCTRL"
ToggleButton.TextColor3 = VORTEX_WHITE
...
ToggleButtonStroke.Color = VORTEX_RED_DARK
ToggleButtonStroke.Transparency = 0.3
...
SaveRow.Position = UDim2.new(0,10,0,188)
